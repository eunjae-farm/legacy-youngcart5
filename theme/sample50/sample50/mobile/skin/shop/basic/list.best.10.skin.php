...
if($this->total_count > 0) {
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        if($i == 0) {
            ...
            echo '<div id="sbest_list">'.PHP_EOL;
        ...
        echo '<li class="sct_li"'.$li_width_style.'><div class="li_wr">'.PHP_EOL;

        if ($this->href) {
            echo '<div class="sct_img"><a href="'.$this->href.$row['it_id'].'" class="sct_a">'.PHP_EOL;
        }
       echo "<span class=\"sct_rank\"><span class=\"num\">0".$k." </span><span class=\"text\">BEST</span></span>\n";
        ...
        if ($this->view_it_baisc) {
            echo "<div class=\"sct_sub_txt\">".get_text($row['it_baisc'])."</div>\n";
        }
