...
<div class="register">
	...
	<div class="register_inner">
	    ...
	    <div class="form_01 personal_date">
	        ...
	        <ul>
		        ...
		        <li id="ads">
		            <span class="frm_label"><span class="sound_only">주소</span><?php if ($config['cf_req_addr']) { ?><strong class="sound_only">필수</strong><?php } ?></span>
		            ...
		            <button type="button" class="btn_frmline2" onclick="win_zip('fregisterform', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');">주소 검색</button>
		            <br>
		            <label for="reg_mb_addr1">주소<?php echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?></label>
	    ...
	    <div class="form_01 personal_setting">
	        ...
	        <ul>
				...
				<li>
		            <label for="reg_mb_signature">서명<?php if ($config['cf_req_signature']){ ?><strong>필수</strong><?php } ?></label>
		        ...
		        <li class="mem_pic">
		            ...
		            <span class="frm_info">
		               <i class="fa fa-exclamation-circle"></i> 이미지 크기는 가로 <?php echo $config['cf_member_icon_width'] ?>픽셀, 세로 <?php echo $config['cf_member_icon_height'] ?>픽셀 이하로 해주세요.<br>
		        ...
		        <li class="mem_pic">
		            ...
		            <span class="frm_info">
		                <i class="fa fa-exclamation-circle"></i> 이미지 크기는 가로 <?php echo $config['cf_member_img_width'] ?>픽셀, 세로 <?php echo $config['cf_member_img_height'] ?>픽셀 이하로 해주세요.<br>
                    ...
                    <span class="bo_chk li_chk">
                        ...
                        <label for="del_mb_img"><span class="chk_img"></span> 삭제</label>
                    </span>
		            <?php }  ?>
		        </li>
		        <?php } ?>
		        ...
		        <li class="frm_bar">
		            <span class="bo_chk li_chk">
                        ...
                        <label for="reg_mb_mailling" class="frm_label mailling"><span class="chk_img"></span> 정보 메일을 받겠습니다.</label>
                    </span>
		        </li>
		        ...
		        <li class="frm_bar">
                    <span class="bo_chk li_chk">
                        <input type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w=='' || $member['mb_sms'])?'checked':''; ?>> <label for="reg_mb_sms" class="frm_label frm_sms"><span class="chk_img"></span> 휴대폰 문자메세지를 받겠습니다.</label>
		        ...
		        <li>
		        	<div class="frm_bar">
                        <span class="bo_chk li_chk">
                            <input type="checkbox" name="mb_open" value="1" id="reg_mb_open" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?>> <label for="reg_mb_open" class="frm_label info_open"><span class="chk_img"></span> 다른분들이 나의 정보를 볼 수 있도록 합니다.</label>
                            <input type="hidden" name="mb_open_default" value="<?php echo $member['mb_open'] ?>">
                            
                            
                        </span>
		            </div>
		            <span class="frm_info frm_center"><i class="fa fa-exclamation-circle"></i> 정보공개를 바꾸시면 앞으로 <?php echo (int)$config['cf_open_modify'] ?>일 이내에는 변경이 안됩니다.</span>
		        </li>
		        <?php } else { ?>
		        <li>
		        	<div class="frm_bar">
		            <input type="hidden" name="mb_open" value="<?php echo $member['mb_open'] ?>"> 정보공개
		            </div>
		            <span class="frm_info">
    ...
    <div class="btn_top">
	    <a href="<?php echo G5_URL ?>" class="btn_l btn_b01">취소</a>
	    <button type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn_b02 btn_submit btn_l" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
	</div>
